    ...
    <footer className="bg-[#fbc85b] text-black py-8 px-6 md:px-16 lg:px-24 w-full border-t border-white/5 font-poppins">
      <div className="max-w-9xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-20 mb-8">
          ...
          {/* Brand Info & Socials (Follow Us moved here) */}
          <div className="space-y-8">
            ...
            {/* --- Follow Us (Now under the Logo/Text) --- */}
            <div className="space-y-4">
              <span className="font-bold text-sm tracking-widest uppercase text-black block">Follow Us:</span>
          ...
          {/* Company Links */}
          <div>
            <h4 className="text-black text-lg font-bold tracking-widest uppercase mb-6 mt-6">Company</h4>
            <ul className="text-black text-sm font-medium space-y-2">
              <li><a href="#" className="text-lg hover:text-blue-900 transition-colors">Projects</a></li>
              <li><a href="#" className="text-lg hover:text-blue-900 transition-colors">About Us</a></li>
              <li><a href="#" className="text-lg hover:text-blue-900 transition-colors">Services</a></li>
              <li><a href="#" className="text-lg hover:text-blue-900 transition-colors">Career</a></li>
            </ul>
          </div>

          {/* Support Links */}
          <div>
            <h4 className="text-black text-lg font-bold tracking-widest uppercase mb-6 mt-6">Support</h4>
            <ul className="text-black text-sm font-medium space-y-2">
              <li><a href="#" className="text-lg hover:text-blue-900 transition-colors">Terms & Condition</a></li>
              <li><a href="#" className="text-lg hover:text-blue-900 transition-colors">Privacy Policy</a></li>
              <li><a href="#" className="text-lg hover:text-blue-900 transition-colors">FAQs</a></li>
            </ul>
          </div>
          ...
          <div className="space-y-6">
            <div>
              <h4 className="text-black text-lg font-bold tracking-widest uppercase mb-5 mt-6">Office</h4>
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-5">
                ...
                <div className="flex flex-col">
                  ...
                  <a href="tel:+918601515055" className="text-xl font-bold text-black hover:underline hover:text-blue-900">+91 8601515055</a>
                </div>
              </div>
              <div className="flex items-center gap-5">
        ...
        {/* --- Bottom Section: Copyright (Middle Aligned) --- */}
        <div className="pt-6 border-t border-black/10 text-center">
          <p className="text-black text-xs md:text-sm tracking-widest  font-medium">
            © 2026 Design & Developed by <a href="https://www.nexverratechnologies.com/" target="_blank" rel="noopener noreferrer" className="hover:underline text-blue-900 font-semibold">NEXVERRA TECHNOLOGIES</a>. All Rights Reserved.
          </p>
        </div>
...
//     <footer className="bg-[#fbc85b] text-black py-5 px-6 md:px-16 lg:px-24 w-full border-t border-white/5 font-poppins">
//       <div className="max-w-9xl mx-auto">
...
//                 </Link>
//               </div>
//               {/* <span className="text-xl text-black font-black tracking-tighter ml-8">Vs</span> */}
//               <span className="text-xl font-bold text-black  tracking-tighter py-5 ml-5">Trading Company</span>
//             </div>
