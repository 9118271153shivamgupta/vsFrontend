...
// import { REVIEWS_DATA } from '../reviews/ReviewData'; // commented as per original
...
const CustomersPage = () => {
  ...
  return (
    <div className="bgwhite min-h-screen w-full font-poppins bg-white">
      ...
      <section className="relative py-12 md:py-20 px-6 overflow-hidden ">
        <div className="max-w-7xl mx-auto text-center relative z-10">
          ...
          <motion.h1 
            ...
            className="text-4xl md:text-6xl font-semibold text-gray-900 mt-2 mb-4"
          >
            Customer <span className="text-[#d2940e] font-light italic ">Spotlight</span>
          </motion.h1>
          <p className="max-w-xl mx-auto text-gray-500 text-base md:text-lg leading-relaxed">
            Discover why thousands trust us to turn dream spaces into reality. 
            Watch their journeys and transformations.
          </p>
        </div>
      </section>

      {/* 2. STATS BAR - Responsive 2x2 on Mobile */}
      <section className="border-y border-gray-100  ">
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8">
          {stats.map((stat, i) => (
            <div key={i} className="text-center">
              <h3 className="text-2xl md:text-3xl font-semibold text-gray-900">{stat.value}</h3>
              <p className="text-gray-400 text-[10px] md:text-xs font-semibold uppercase mt-1 tracking-wider">{stat.label}</p>
            </div>
          ))}
        </div>
      </section>
        ...
        {activeVideo && (
          ...
          >
            <motion.div 
              ...
              className="w-full max-w-4xl aspect-video rounded-2xl overflow-hidden shadow-2xl relative bg-black"
